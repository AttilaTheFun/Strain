...
extension UITableViewCell {
    ...
    /**
     When adding a view as a subview of a UITableViewCell, you *must* add it as a subview of the content view *and* make the bottom constraint priority less than
     required. This is because as part of the UITableView autolayout algorithm, during the first layout pass, the height may be zero or incorrect.
